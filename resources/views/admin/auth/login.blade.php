					...
					<div class="crancy-wc__form--middle">
						...
						<div class="crancy-wc__form-inner common-flex">
							<div class="crancy-wc__logo">
								<img src="{{ asset('japan_home/japan-logo.png') }}" alt="logo" style="width:40px;height:40px; margin-right: 30px; margin-bottom: 10px">
								...
								<div class="single-slider">
									<div class="crancy-wc__slider--single">
										<div class="crancy-wc__slider--content">
											<h4 class="crancy-wc__slider--title">{{ __('Welcome to Alpine Japan') }}</h4>
										</div>
									</div>
								</div>
							</div>
