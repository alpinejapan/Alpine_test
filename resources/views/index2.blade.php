                                ...
                                <div class="taitel-img">
                                    <span>
                                        <svg width="71" height="8" viewBox="0 0 71 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1 6.08589C15.5 0.18137 51.5 -0.151783 70 6.42496" stroke="#ee3536" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
                                    </span>
                                </div>
                    ...
                    <div class="categories-close-img-main">
                        @if ($home2_ads->status == 'enable')
                            <div class="categories-close-img">
                                <a href="{{ $home2_ads->link }}" target="_blank"> <img src="{{ asset($home2_ads->image) }}" alt="img"></a>
                            </div>
                        @endif
                    </div>
                </div>
                        ...
                        <div class="taitel-img">
                            <span>
                                <svg width="126" height="6" viewBox="0 0 126 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 5C17.9496 1.98151 66.4791 -2.24439 125 5" stroke="#EE3536" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                        ...
                        <div class="taitel-img">
                            <span>
                                <svg width="188" height="6" viewBox="0 0 188 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 5C26.4245 1.98151 99.2187 -2.24439 187 5" stroke="#EE3536" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
            ...
            <div class="row mt-60px">
                <div class="col-lg-12">
                    ...
                    <div class="brand-car-btn mt-48px">
                        <a href="{{ route('listings') }}" class="thm-btn-thr">{{ __('translate.View More Car List') }}</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center text-center">
                <div class="col-lg-6">
                    <div class="taitel thr">
                        <div class="taitel-img">
                            <span>
                                <svg width="238" height="6" viewBox="0 0 238 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1.73535 5C33.8577 1.98151 125.829 -2.24439 236.735 5" stroke="#EE3536" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                        ...
                        <div class="taitel-img">
                            <span>
                                <svg width="116" height="6" viewBox="0 0 116 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 5C16.5827 1.98151 61.1986 -2.24439 115 5" stroke="#EE3536" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                    ...
                    <div class="col-lg-3">
                        <div class="dealer-two-item">
                            ...
                            <div class="dealer-two-item-btn">
                                <a href="{{ route('dealer', $dealer->username) }}" class="thm-btn-thr">{{ __('translate.Visit Profile') }}</a>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="taitel thr">
                        <div class="taitel-img">
                            <span>
                                <svg width="129" height="6" viewBox="0 0 129 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1.5 5C18.723 1.98151 68.0353 -2.24439 127.5 5" stroke="#EE3536" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
