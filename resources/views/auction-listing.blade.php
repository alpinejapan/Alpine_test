                                        ...
                                        <div class="col-lg-6 ">
                                            <ul class="key-information" >
                                                ...
                                                <li>
                                                    ...
                                                    {{empty($car->displacement) ? '--' : $car->displacement}}
                                                ...
                                                <li>
                                                    ...
                                                    {{ html_decode(empty($car->model_grade_en) ? '--' :$car->model_grade_en) }}
                                                </li>
                                                ...
                                                <li>
                                                    ...
                                                    {{ html_decode(empty($car->model_year_en) ? '--' : $car->model_year_en) }}
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="col-lg-6 ">
                                            ...
                                            <li>
                                                ...
                                                <li>
                                                    ...
                                                    {{ html_decode(empty($car->mileage_en) ? '--' : $car->mileage_en) }}
                                                </li>
                                                <li>
                                                    <span>
                                                    ...
                                                    {{ html_decode(empty($car->number_of_owner) ? '--' : $car->number_of_owner) }}
                                                </li>
                                                ...
                                                <li>
                                                    ...
                                                    {{ html_decode(empty($car->color_en) ? '--' : $car->color_en) }}
                                                </li>
                                                ...
                                                <li>
                                                    ...
                                                    {{ html_decode(empty($car->fuel_type) ? '--' : $car->fuel_type) }}
                                                </li>
