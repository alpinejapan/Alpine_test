    ...
    <div class="menu-bar">
        <ul id="CrancyMenu" class="menu-bar__one crancy-dashboard-menu">
            ...
            <li class="{{ Route::is('admin.brand*') || Route::is('admin.city*') || Route::is('admin.feature*') || Route::is('admin.car*') || Route::is('admin.select-car-purpose') || Route::is('admin.featured-car') || Route::is('admin.awaiting-car') || Route::is('admin.review-list') || Route::is('admin.review-detail') ? 'active' : '' }}"><a href="#!" class="collapsed" data-bs-toggle="collapse" data-bs-target="#menu-item__car_list"><span class="menu-bar__text">
                ...
                <!-- Dropdown Menu -->
                <div class="collapse crancy__dropdown {{ Route::is('admin.brand*') || Route::is('admin.city*') || Route::is('admin.feature*') || Route::is('admin.car*') || Route::is('admin.select-car-purpose') || Route::is('admin.featured-car') || Route::is('admin.awaiting-car') || Route::is('admin.review-list') || Route::is('admin.review-detail') ? 'show' : '' }}" id="menu-item__car_list"  data-bs-parent="#CrancyMenu">
