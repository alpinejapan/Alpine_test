        ...
        <div class="wsus__wizard_body">
            ...
            <div class="wsus__wizard_main_content">
                <ul>
                    ...
                    <li><span>Update Public Files</span><a class="replace_btn" href="javascript:;" data-action_type="replace_public_asset_file">Update</a></li>
...
<script>
    ...
    $(".run_migration").on("click", function(e) {
        ...
        let origin_url = modifiedURL + "/migrate-for-update";
