                                        ...
                                        <div class="crancy-product-card">
                                            ...
                                            <div class="col-4">
                                                    <div class="crancy__item-form--group w-100 h-100">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="location" id="location" value="{{$commercial->location}}">
                                                        @error('location')
                                                            <div style="color: red;">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="row mg-top-30">
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group w-100 h-100">
                                                        ...
                                                        <textarea name="remarks" id="remarks" class='crancy__item-input crancy__item-textarea summernote'>{{$commercial->remarks}}</textarea>
                                                        @error('remarks')
                                                            <div style="color: red;">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                    <div class="crancy__item-form--group w-100 h-100">
                                                        ...
                                                        <textarea name="sell_points" id="sell_points" class='crancy__item-input crancy__item-textarea summernote'>{{$commercial->sell_points}}</textarea>
                                                        @error('sell_points')
                                                            <div style="color: red;">{{ $message }}</div>
                                                        @enderror
                                                    </div>
