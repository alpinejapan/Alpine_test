                                        ...
                                        <tbody class="crancy-table__body">
                                            @foreach ($contact_messages as $index => $contact_message)
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a href="{{ route('admin.show-message', $contact_message->id) }}" style="color:grey;"><i class="fas fa-eye"></i></a>

                                                        <a onclick="itemDeleteConfrimation({{ $contact_message->id }})" href="javascript:;" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fas fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
