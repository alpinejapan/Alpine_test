...
@section('title')
    <title>{{ __('translate.Import Companies') }}</title>
@endsection

@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('translate.Import Companies') }}</h3>
    <p class="crancy-header__text">{{ __('translate.Imports') }} >> {{ __('translate.Import Companies') }}</p>
@endsection
                                    ...
                                    <div class="col-12 mg-top-30">
                                        ...
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                <h4 class="crancy-product-card__title">{{ __('translate.Import Companies') }}</h4>
