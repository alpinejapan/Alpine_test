...
@section('body-header')
    ...
    <a href="{{route('admin.dashboard')}}"><p class="crancy-header__text">{{ __('translate.Manage Pages') }} >> {{ __('translate.Contact Us') }}</p></a>
@endsection
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <textarea class="crancy__item-input crancy__item-textarea seo_description_box"  name="description" id="description">{{ $translate->description }}</textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="address" id="address" value="{{ $translate->address }}">
                                                    </div>
                                                </div>
