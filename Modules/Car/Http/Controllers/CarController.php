...
class CarController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        if($request->purpose == 'Rent'){
            ...
            return view('car::create_rent_car', compact('brands', 'cities', 'features', 'dealers'));
            ...
            return view('car::create_sale_car', compact('brands', 'cities', 'features', 'dealers'));
        }else{
            abort(404);
        };
    ...
    public function edit(Request $request, $id)
    {
        ...
        if($car->purpose == 'Rent'){
            ...
            return view('car::edit_rent_car', compact('brands', 'cities', 'features', 'dealers', 'car', 'existing_features', 'car_translate'));
            ...
            return view('car::edit_sale_car', compact('brands', 'cities', 'features', 'dealers', 'car', 'car_translate', 'existing_features'));
